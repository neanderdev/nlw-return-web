        ...
        <>
            ...
            <div className='flex flex-col items-center py-10 w-[304]'>
                ...
                <button
                    ...
                    className='py-2 px-6 mt-6 bg-zinc-800 rounde-md border-transparent text-sm leading-6 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500 transition-colors'
                >
                    Quero enviar outro
                </button>
            </div>
